/* ============================================================================
   Data Sulus UI — поведение контента страниц: табы, карусель, аккордеон, reveal,
...
(function () {
  ...
  function openStub(kind) {
    var map = {
      ...
      social: ['Соцсети скоро', 'Официальные аккаунты Data Sulus появятся к публичному запуску.'],
